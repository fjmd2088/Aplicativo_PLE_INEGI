                ...
                if (cmb_entidad_federativa.SelectedItem != null)
                {
                    try
                    {
                        ...
                        if (rowView != null)
                        {
                            ...
                            // NUEVA CONSULTA PARA LLENAR Ayuntamiento Urgentes Obvias ------------------------------------------------------------
                            string queryAyuntamiento_uo = "SELECT nom_mun FROM TC_AGEEM WHERE nom_ent = @ayuntamiento";
                            using (SQLiteCommand cmdGrupoParlamentario = new SQLiteCommand(queryAyuntamiento_uo, conexion))
                            {
                                cmdGrupoParlamentario.Parameters.AddWithValue("@ayuntamiento", entidad_federativa);
                                ...
                                // Llenar el ComboBox "cmb_varios_grupos_parlamentarios_especifique_1" con los resultados de la consulta
                                cmb_ayuntamiento_uo.DisplayMember = "nom_mun";
                                cmb_ayuntamiento_uo.ValueMember = "nom_mun";  // Opcional si necesitas usar el valor en otro lugar
                                cmb_ayuntamiento_uo.DataSource = tableGrupoParlamentario;

                                // Opcional: Configurar el modo de autocompletar y el estilo del ComboBox
                                cmb_ayuntamiento_uo.AutoCompleteMode = AutoCompleteMode.SuggestAppend;
                                cmb_ayuntamiento_uo.AutoCompleteSource = AutoCompleteSource.ListItems;
                                cmb_ayuntamiento_uo.DropDownStyle = ComboBoxStyle.DropDown;

                            }

                            // NUEVA CONSULTA PARA LLENAR Ayuntamiento Juicio Politicos ------------------------------------------------------------
                            string queryAyuntamiento_jp = "SELECT nom_mun FROM TC_AGEEM WHERE nom_ent = @ayuntamiento";
                            using (SQLiteCommand cmdGrupoParlamentario = new SQLiteCommand(queryAyuntamiento_jp, conexion))
                            {
                                cmdGrupoParlamentario.Parameters.AddWithValue("@ayuntamiento", entidad_federativa);
                                ...
                                // Llenar el ComboBox "cmb_varios_grupos_parlamentarios_especifique_1" con los resultados de la consulta
                                cmb_municipio_persona_servidora_publica_juicio_politico.DisplayMember = "nom_mun";
                                cmb_municipio_persona_servidora_publica_juicio_politico.ValueMember = "nom_mun";  // Opcional si necesitas usar el valor en otro lugar
                                cmb_municipio_persona_servidora_publica_juicio_politico.DataSource = tableGrupoParlamentario;

                                // Opcional: Configurar el modo de autocompletar y el estilo del ComboBox
                                cmb_municipio_persona_servidora_publica_juicio_politico.AutoCompleteMode = AutoCompleteMode.SuggestAppend;
                                cmb_municipio_persona_servidora_publica_juicio_politico.AutoCompleteSource = AutoCompleteSource.ListItems;
                                cmb_municipio_persona_servidora_publica_juicio_politico.DropDownStyle = ComboBoxStyle.DropDown;
                            ...
                            using (SQLiteCommand cmdGrupoParlamentario = new SQLiteCommand(queryAyuntamiento_dp, conexion))
                            {
                                ...
                                // Llenar el ComboBox "cmb_varios_grupos_parlamentarios_especifique_1" con los resultados de la consulta
                                cmb_municipio_persona_servidora_publica_declaracion_procedencia.DisplayMember = "nom_mun";
                                cmb_municipio_persona_servidora_publica_declaracion_procedencia.ValueMember = "nom_mun";  // Opcional si necesitas usar el valor en otro lugar
                                cmb_municipio_persona_servidora_publica_declaracion_procedencia.DataSource = tableGrupoParlamentario;

                                // Opcional: Configurar el modo de autocompletar y el estilo del ComboBox
                                cmb_municipio_persona_servidora_publica_declaracion_procedencia.AutoCompleteMode = AutoCompleteMode.SuggestAppend;
                                cmb_municipio_persona_servidora_publica_declaracion_procedencia.AutoCompleteSource = AutoCompleteSource.ListItems;
                                cmb_municipio_persona_servidora_publica_declaracion_procedencia.DropDownStyle = ComboBoxStyle.DropDown;
